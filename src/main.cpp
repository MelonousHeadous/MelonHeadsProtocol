...
#if defined(NDEBUG)
# error "MelonHeadsProtocol cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MelonHeadsProtocol Signed Message:\n";
...
{
    RenameThread("melonheadsprotocol-loadblk");
